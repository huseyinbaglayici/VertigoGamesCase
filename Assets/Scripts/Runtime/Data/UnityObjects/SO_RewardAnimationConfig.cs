...
namespace Runtime.Data.UnityObjects
{
    ...
    public class SO_RewardAnimationConfig : ScriptableObjectInstaller
    {
        ...
        {
            [Header("Scatter")] public float spreadRadius = 30f;
            public float scatterDuration = 0.2f;
            public Ease scatterEase = Ease.OutBack;

            [Header("Jump")] public float jumpHeight = 60f;
            public float jumpDuration = 0.15f;

            [Header("Scroll")] public float scrollDuration = 0.3f;

            [Header("Fly")] public float flyDuration = 0.45f;
